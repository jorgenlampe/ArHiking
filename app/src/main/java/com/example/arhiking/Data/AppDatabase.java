...
@Database(entities = {User.class, Hike.class, HikeActivities.class}, version = 15, autoMigrations = {
        @AutoMigration (from = 14, to = 15, spec = AppDatabase.MyAutoMigration.class)
}, exportSchema = true)
